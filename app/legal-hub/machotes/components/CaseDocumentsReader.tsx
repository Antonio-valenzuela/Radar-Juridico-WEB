          ...
          <div className="contestaciones-col-left">
            <div className="contestaciones-card">
              ...
              {!selectedDoc ? (
                ...
                >
                  <div style={{ width: '40px', height: '40px', borderRadius: '50%', background: '#ffffff', border: '1px solid #cbd5e1', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '18px', color: '#64748b', margin: '0 auto' }}>
                    ↑
                  </div>
        ...
        <div className={showSourcePanel ? 'contestaciones-col-right' : 'contestaciones-col-full'}>
          <div className="contestaciones-card">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
              ...
              {/* Usar el nuevo componente de análisis formateado */}
              <LegalAnalysisDisplay 
                caseAnalysis={caseAnalysis}
                selectedPill={selectedAnalysisPill as any}
              />
            </div>
...
interface LegalAnalysisDisplayProps {
  caseAnalysis: CaseAnalysis;
  selectedPill: 'prestaciones' | 'hechos' | 'puntos' | 'excepciones' | 'defensas' | 'pruebas' | 'fundamentos';
}

function LegalAnalysisDisplay({ caseAnalysis, selectedPill }: LegalAnalysisDisplayProps) {
  return (
    <div style={{ 
      background: '#f8fafc', 
      border: '1px solid #e2e8f0', 
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
          ...
          {caseAnalysis.claims.length > 0 ? (
            <ul style={{ 
              ...
              {caseAnalysis.claims.map((claim, i) => (
                <li 
                  key={i} 
                  style={{ 
                    color: '#1e293b',
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
          ...
          {caseAnalysis.proceduralTimeline.length > 0 ? (
            <div style={{ 
              ...
              {caseAnalysis.proceduralTimeline.map((event, i) => (
                <div 
                  key={i} 
                  style={{ 
                    background: '#fafbfc',
                ...
                >
                  <div style={{ 
                    ...
                    {event.date ? `📅 ${event.date}` : '📌 Sin fecha'}
                  </div>
                  <div style={{ 
                    color: '#334155',
                    fontSize: '12px',
            ...
            <div style={{ 
              ...
              No se detectaron hechos relevantes en el documento.
            </div>
          )}
        </div>
      )}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
          ...
          {caseAnalysis.proceduralPosture.constitutionalIssues.length > 0 ? (
            <div style={{ 
              ...
              {caseAnalysis.proceduralPosture.constitutionalIssues.map((issue, i) => (
                <div 
                  key={i}
                  style={{ 
                    background: '#fef3c7',
                ...
                >
                  ...
                  {issue.parameter && (
                    <div style={{ 
                      ...
                      <span style={{ fontWeight: 600 }}>Parámetro:</span> {issue.parameter}
                    </div>
                  )}
                </div>
              ))}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
          ...
          {caseAnalysis.caseTheory?.vulnerabilities?.length > 0 ? (
            <ul style={{ 
              ...
              {caseAnalysis.caseTheory.vulnerabilities.map((vuln, i) => (
                <li 
                  key={i}
                  style={{ 
                    margin: 0,
            ...
            <div style={{ 
              ...
              No se detectaron excepciones procesales relevantes.
            </div>
          )}
        </div>
      )}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
          ...
          {caseAnalysis.argumentAxes.length > 0 ? (
            <div style={{ 
              ...
              {caseAnalysis.argumentAxes.map((axis, i) => (
                <div 
                  key={i}
                  style={{ 
                    background: '#ecfdf5',
                ...
                >
                  ...
                  <div style={{ 
                    ...
                    {axis.reasoning || axis.rebuttal || 'Sin descripción'}
                  </div>
                </div>
              ))}
            </div>
            ...
            <div style={{ 
              ...
              No se definió estrategia de defensa en esta etapa.
            </div>
          )}
        </div>
      )}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
          ...
          {caseAnalysis.evidence.length > 0 ? (
            <ul style={{ 
              ...
              {caseAnalysis.evidence.map((evidence, i) => (
                <li 
                  key={i}
                  style={{ 
                    margin: 0,
                ...
                >
                  <span style={{ fontSize: '14px', marginTop: '-2px' }}>📋</span>
                  <div>
                    <div style={{ fontWeight: 700 }}>{evidence.type || 'Prueba'}</div>
                    <div style={{ fontSize: '11px', marginTop: '2px', opacity: 0.8 }}>{evidence.description}</div>
                  </div>
                </li>
              ))}
            </ul>
            ...
            <div style={{ 
              ...
              No se especificaron pruebas necesarias en esta etapa.
            </div>
          )}
        </div>
      )}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
          ...
          {caseAnalysis.citations.length > 0 ? (
            <div style={{ 
              ...
              {caseAnalysis.citations.map((citation, i) => (
                <div 
                  key={i}
                  style={{ 
                    background: '#f3e8ff',
                ...
                >
                  ...
                  <div style={{ 
                    ...
                    Registro: <strong>{citation.registro || 'N/A'}</strong>
                  </div>
                </div>
              ))}
            </div>
